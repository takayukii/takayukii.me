								...
								<?php if (rwmb_meta('wtf_port_cats') == 'value1') { ?>
									<p>
										<bt><?php _e('Type', 'gents'); ?>
											: </span><?php echo get_the_term_list(get_the_ID(), 'portfolio_cats', '', ', ', ' ') ?></bt>
									</p>
								<?php } ?>
							</div><!-- col-lg-8 -->
						</div>
		...
		<?php else : ?>
			...
			<div class="container">
				<article id="post-not-found" class="hentry clearfix">
					...
					<footer>
						<h6><?php _e('You can return', 'gents'); ?>
							<a href="<?php echo home_url(); ?>/" title="<?php esc_attr_e('Home', 'gents'); ?>"><?php _e('&#9166; Home', 'gents'); ?></a>
							<?php _e('or search for the page you were looking for', 'gents'); ?>
						</h6>
						<?php get_search_form(); ?>
					</footer>
